...
class CartItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $insert_check = CartItem::where('user_id', $user_id)->where('item_id', $item_id)->exists();
        if($insert_check){
            CartItem::where('user_id', $user_id)->where('item_id', $item_id)->increment('quantity', $request->quantity);;
        }else{
            CartItem::create(['user_id' => $user_id, 'item_id' => $item_id, 'quantity' => $request->quantity]);
        }
